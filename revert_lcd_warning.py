...
html_replacements = [
    {
        'old': r'<p class="lcd-heavy-warning" style="font-size: 0\.8rem; color: red; margin-top: 10px; display: none;">※ 화면 및 터치 불량으로 초기화가 되지 않은경우 개인정보초기화를 고객님의 잠금 비밀번호, 애플ID 및 비밀번호를 필요로 할 수 있습니다\.</p>',
        'new': r''
    }
]
