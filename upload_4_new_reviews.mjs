...
const reviewsData = [
  ...
  },
  {
    ...
    rating: 5,
    text: "거의 100만 원 돈 하는 기기를 얼굴도 안 보고 택배로만 보낸다는 게 솔직히 엄청 불안했거든요. 그래서 발송 전에 고객센터에 여러 번 전화해서 이것저것 귀찮게 캐물었는데, 매번 너무 친절하고 다정하게 안심시켜 주셨어요. 덕분에 맘 편히 거래했습니다. CS팀 직원분들 진짜 최고예요!",
    userName: "오*민",
    userId: "anonymous",
