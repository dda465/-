...
// Insert it right after the line that was preserved: \`if (window.openPresaleModal) window.openPresaleModal();\n            });\n        }\n    }\`
...
if (idx !== -1) {
    ...
    if(idx2 !== -1) {
        ...
        if(postIdx !== -1) {
            ...
            const newContent = startPart + "\\n" + missingCode + "\\n" + endPart;
            fs.writeFileSync('script.js', newContent, 'utf8');
            console.log('Recovery successful (fallback regex).');
        } else {
