...
const reviewsData = [
  {
    ...
    userName: "정*호",
    userId: "anonymous",
    createdAt: Timestamp.fromDate(new Date("2026-04-04T10:30:00+09:00")),
    imageUrl: null
  },
  {
    ...
    userName: "최*훈",
    userId: "anonymous",
    createdAt: Timestamp.fromDate(new Date("2026-04-05T14:15:00+09:00")),
    imageUrl: null
  },
  {
    deviceModel: "갤럭시 S21",
    ...
    userName: "강*영",
    userId: "anonymous",
    createdAt: Timestamp.fromDate(new Date("2026-04-06T16:45:00+09:00")),
    imageUrl: null
  },
  {
    ...
    userName: "유*진",
    userId: "anonymous",
    createdAt: Timestamp.fromDate(new Date("2026-04-07T11:20:00+09:00")),
    imageUrl: null
  },
  {
    ...
    userName: "임*석",
    userId: "anonymous",
    createdAt: Timestamp.fromDate(new Date("2026-04-08T15:50:00+09:00")),
    imageUrl: null
  },
  {
    deviceModel: "아이폰 14",
    ...
    userName: "송*아",
    userId: "anonymous",
    createdAt: Timestamp.fromDate(new Date("2026-04-09T18:10:00+09:00")),
    imageUrl: null
  },
  {
    deviceModel: "갤럭시 A53",
    ...
    userName: "한*수",
    userId: "anonymous",
    createdAt: Timestamp.fromDate(new Date("2026-04-10T13:00:00+09:00")),
    imageUrl: null
  }
];

async function seed() {
  console.log("Starting seed of 7 new reviews...");
  try {
