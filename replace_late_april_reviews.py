...
# 1. Fetch and delete existing generated reviews
print("Fetching existing reviews to delete old ones...")
try:
    ...
    target_users = ["최*식", "김*아", "정*숙", "이*영", "강*석", "윤*호", "송*진", "임*현", "한*미", "박*원"]
...
reviews = [
    ...
    },
    {
        ...
        "transactionPrice": {"stringValue": "52만원"}, # A급 55, C급 46
        "rating": {"integerValue": "5"},
    ...
    },
    {
        ...
        "deviceStorage": {"stringValue": "256GB"},
        "transactionPrice": {"stringValue": "16만원"}, # A급 18, C급 14.8
    ...
    },
    {
        ...
        "transactionPrice": {"stringValue": "48만원"}, # A급 50, C급 47.5
        "rating": {"integerValue": "5"},
    ...
    },
    {
        ...
        "deviceStorage": {"stringValue": "512GB"},
        "transactionPrice": {"stringValue": "77만원"}, # A급 77, C급 76.5
        "rating": {"integerValue": "5"},
    ...
    },
    {
        ...
        "deviceStorage": {"stringValue": "128GB"},
        "transactionPrice": {"stringValue": "29만원"}, # A급 30, C급 27.5
        "rating": {"integerValue": "4"},
    ...
    },
    {
        ...
        "transactionPrice": {"stringValue": "12만원"}, # A급 12, C급 11.5
        "rating": {"integerValue": "5"},
    ...
    },
    {
        ...
        "deviceStorage": {"stringValue": "256GB"},
        "transactionPrice": {"stringValue": "28만원"}, # A급 29.5, C급 25.5
        "rating": {"integerValue": "5"},
    ...
    },
    {
        ...
        "deviceStorage": {"stringValue": "256GB"},
        "transactionPrice": {"stringValue": "25만원"}, # A급 27, C급 23
        "rating": {"integerValue": "4"},
    ...
    },
    {
        ...
        "deviceStorage": {"stringValue": "128GB"},
        "transactionPrice": {"stringValue": "15만원"}, # A급 16, C급 14
        "rating": {"integerValue": "5"},
...
for review in reviews:
    ...
    try:
        ...
        print(f"Added updated review for {review['deviceModel']['stringValue']} at {review['transactionPrice']['stringValue']}")
