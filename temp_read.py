...
with open('output.txt', 'w', encoding='utf-8') as out_f:
    search_file("quote.html", "wizard-step-auth", out_f)
    search_file("quote.html", "termsModal", out_f)
    search_file("script.js", "btn-auth-next", out_f)
    search_file("script.js", "wizard-step-terms", out_f)
